...
class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'fsq-developers/v1.0 (api/6.1.2)');
  }
...
export type { AddressDetailsMetadataParam, AddressDetailsResponse200, AutocompleteMetadataParam, AutocompleteResponse200, FeedbackStatusMetadataParam, FeedbackStatusResponse200, PlaceDetailsMetadataParam, PlaceDetailsResponse200, PlaceFlagMetadataParam, PlaceFlagResponse200, PlaceMatchMetadataParam, PlaceMatchResponse200, PlacePhotosMetadataParam, PlacePhotosResponse200, PlaceProposeEditMetadataParam, PlaceProposeEditResponse200, PlaceSearchMetadataParam, PlaceSearchResponse200, PlaceSelectMetadataParam, PlaceSelectResponse200, PlaceTipsMetadataParam, PlaceTipsResponse200, PlacesNearbyMetadataParam, PlacesNearbyResponse200 } from './types';
